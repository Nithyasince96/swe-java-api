...
public class SwephExp {
    ...
    public SwephExp(String libraryName) {
        loadSweLibrary(libraryName);
    }

    public static void loadSweCurrentLibrary() {
        loadSweLibrary(SWISSEPH_LIBRARY_NAME);
    }

    public static void loadSweLibrary(String libraryName) {
        if (!sweLibraryLoaded) {
    ...
    public static boolean isSweLibraryLoaded() {
        return sweLibraryLoaded;
    }
